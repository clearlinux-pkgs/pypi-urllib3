...
Source0  : https://files.pythonhosted.org/packages/25/36/f056e5f1389004cf886bb7a8514077f24224238a7534497c014a6b9ac770/urllib3-1.26.10.tar.gz
...
%prep
%setup -q -n urllib3-1.26.10
cd %{_builddir}/urllib3-1.26.10
pushd ..
cp -a urllib3-1.26.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657220553
...
cp %{_builddir}/urllib3-1.26.10/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-urllib3/fae7d86a68e1724238ed64674e4cd743a7dc6796
