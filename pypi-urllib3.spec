...
Source0  : https://files.pythonhosted.org/packages/8b/00/db794bb94bf09cadb4ecd031c4295dd4e3536db4da958e20331d95f1edb7/urllib3-2.0.6.tar.gz
...
%prep
%setup -q -n urllib3-2.0.6
cd %{_builddir}/urllib3-2.0.6
pushd ..
cp -a urllib3-2.0.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696348116
