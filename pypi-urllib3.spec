...
Source0  : https://files.pythonhosted.org/packages/c2/51/32da03cf19d17d46cce5c731967bf58de9bd71db3a379932f53b094deda4/urllib3-1.26.13.tar.gz
...
%prep
%setup -q -n urllib3-1.26.13
cd %{_builddir}/urllib3-1.26.13
pushd ..
cp -a urllib3-1.26.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669397839
