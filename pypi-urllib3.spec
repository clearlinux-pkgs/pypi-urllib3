...
Source0  : https://files.pythonhosted.org/packages/af/47/b215df9f71b4fdba1025fc05a77db2ad243fa0926755a52c5e71659f4e3c/urllib3-2.0.7.tar.gz
...
%prep
%setup -q -n urllib3-2.0.7
cd %{_builddir}/urllib3-2.0.7
pushd ..
cp -a urllib3-2.0.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698245330
...
cp %{_builddir}/urllib3-%{version}/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-urllib3/86e713a60a618065f28eebdc1228b9438180b2f8 || :
...
/usr/share/package-licenses/pypi-urllib3/86e713a60a618065f28eebdc1228b9438180b2f8
