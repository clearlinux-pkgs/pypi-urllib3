...
Source0  : https://files.pythonhosted.org/packages/b0/b1/7bbf5181f8e3258efae31702f5eab87d8a74a72a0aa78bc8c08c1466e243/urllib3-1.26.8.tar.gz
...
%prep
%setup -q -n urllib3-1.26.8
cd %{_builddir}/urllib3-1.26.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641946295
...
cp %{_builddir}/urllib3-1.26.8/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-urllib3/fae7d86a68e1724238ed64674e4cd743a7dc6796
