...
Source0  : https://files.pythonhosted.org/packages/43/6d/fa469ae21497ddc8bc93e5877702dca7cb8f911e337aca7452b5724f1bb6/urllib3-2.2.2.tar.gz
...
%prep
%setup -q -n urllib3-2.2.2
cd %{_builddir}/urllib3-2.2.2
pushd ..
cp -a urllib3-2.2.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720049009
