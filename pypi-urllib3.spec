...
Source0  : https://files.pythonhosted.org/packages/1b/a5/4eab74853625505725cefdf168f48661b2cd04e7843ab836f3f63abf81da/urllib3-1.26.9.tar.gz
...
%prep
%setup -q -n urllib3-1.26.9
cd %{_builddir}/urllib3-1.26.9
pushd ..
cp -a urllib3-1.26.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656364056
...
cp %{_builddir}/urllib3-1.26.9/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-urllib3/fae7d86a68e1724238ed64674e4cd743a7dc6796
