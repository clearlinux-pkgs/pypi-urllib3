...
Source0  : https://files.pythonhosted.org/packages/c5/52/fe421fb7364aa738b3506a2d99e4f3a56e079c0a798e9f4fa5e14c60922f/urllib3-1.26.14.tar.gz
...
%prep
%setup -q -n urllib3-1.26.14
cd %{_builddir}/urllib3-1.26.14
pushd ..
cp -a urllib3-1.26.14 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673454961
