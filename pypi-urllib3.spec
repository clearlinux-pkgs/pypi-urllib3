...
Source0  : https://files.pythonhosted.org/packages/21/79/6372d8c0d0641b4072889f3ff84f279b738cd8595b64c8e0496d4e848122/urllib3-1.26.15.tar.gz
...
%prep
%setup -q -n urllib3-1.26.15
cd %{_builddir}/urllib3-1.26.15
pushd ..
cp -a urllib3-1.26.15 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695157861
