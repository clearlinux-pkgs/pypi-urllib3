...
Source0  : https://files.pythonhosted.org/packages/51/13/62cb4a0af89fdf72db4a0ead8026e724c7f3cbf69706d84a4eff439be853/urllib3-2.0.5.tar.gz
...
%prep
%setup -q -n urllib3-2.0.5
cd %{_builddir}/urllib3-2.0.5
pushd ..
cp -a urllib3-2.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695225102
