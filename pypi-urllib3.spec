...
Source0  : https://files.pythonhosted.org/packages/b2/56/d87d6d3c4121c0bcec116919350ca05dc3afd2eeb7dc88d07e8083f8ea94/urllib3-1.26.12.tar.gz
...
%prep
%setup -q -n urllib3-1.26.12
cd %{_builddir}/urllib3-1.26.12
pushd ..
cp -a urllib3-1.26.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661194531
